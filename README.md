...
![Jatiyo Keyboard Layout Map](bn-Jatiyo-layout.png)
...
১. **অফিসিয়াল টুলটি অনেক পুরোনো:** সরকারি ওয়েবসাইটগুলোতে থাকা মূল লেআউট ফাইলগুলো বেশ পুরোনো এবং এটিতে শর্টকাট কি (Shortcuts) নেই, মনুয়লি লেআউট চেন্জ করতে হয়। <br>
...
### 🚀 ইন্সটলেশন গাইড
১. এই পেজের ডানদিকের/একদম নিচের **Releases** সেকশন এ যান আথবা **[ক্লিক করুন](https://github.com/Jahid015/jatiyo-keyboard-windows/releases/latest)** এবং `jatiyo.zip` ফাইলটি ডাউনলোড করুন। <br>
২. জিপ ফাইলটি আনজিপ (Extract) করে `setup.exe` ফাইলটিতে ডাবল-ক্লিক করে ইন্সটল করুন। <br>
৩. উইন্ডোজের **Settings** (`Win + I`) > **Time & Language** > **Language & Region**-এ যান। <br>
...
![জাতীয় কিবোর্ড লেআউট ম্যাপ](bn-Jatiyo-layout.png)
